...
const Slug = () => {
	...
	const checkServiceability = async () => {
		const response = await axios.post('http://localhost:3000/api/pincode', { pincode: pincode.current.value });
		setIsServicable(response.data);
	};
						...
						<div className='lg:w-2/2 md:w-full lg:w-[50%] lg:pl-10 lg:py-6 mt-6 lg:mt-0'>
							...
							<div className='flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5'>
								<div className='flex'>
									...
									<button className='border-2 border-gray-300 ml-2 bg-gray-700 rounded-full w-6 h-6 focus:outline-none' />
									<button className='border-2 border-gray-300 ml-2 bg-pink-500 rounded-full w-6 h-6 focus:outline-none' />
								</div>
							...
							<div className='flex'>
								...
								<button className='flex ml-4 text-white bg-pink-500 border-0 lg:py-2 lg:px-6 focus:outline-none hover:bg-pink-600 rounded md:p-4 md:px-2 items-center justify-center p-2'>
									Add to cart
								</button>
